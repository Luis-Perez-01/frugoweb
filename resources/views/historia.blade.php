...
@section('content')
<h1 class="position-absolute bottom-50 end-50 text-uppercase text-white p-2"><strong>Una trayectoria <br> de
        excelencia</strong></h1>
<img src="{{asset('assets/bg_acercade_sinblur.jpg')}}" alt="" class=""
    style="min-height: 40vh; max-width: 100%; object-fit: contain;">
    ...
    <article>
        <div class="container">
            ...
            <div class="tab-content" id="nav-tabContent-4">
                <div class="tab-pane fade show active" id="nav-1" role="tabpanel" aria-labelledby="nav-1" tabindex="0">
...
<div class="contenedor">
    <img src="{{asset('assets/bg_calidad.jpg')}}" alt="" class=""
        style="min-height: 40vh; max-width: 100%; object-fit: contain;">
    <div class="centrado h1 text-uppercase text-white" id="presencia"><strong>CALIDAD <br>Y LIDERAZGO</strong></div>
</div>
<section>
...
<img src="{{asset('assets/bg_nuestra.jpg')}}" alt="" class=""
    style="min-height: 40vh; max-width: 100%; object-fit: contain;">
<section>
    <div class="container w-50 py-3" id="equipo">
        <p class="pt-5">
...
<img src="{{asset('assets/bg_expectativas.jpg')}}" alt="" class=""
    style="min-height: 40vh; max-width: 100%; background-size:cover; background-attachment: fixed;">
<section>
    <div class="container w-50 py-3" id="filosofia">
        <p style="color: #3FAE29;">
            <strong>
                Visión
            </strong>
